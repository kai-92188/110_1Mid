    ...
    <form id="form1" runat="server">
        <div>
            ...
            <asp:Label ID="Label3" runat="server" Text="管道得知(可多選)" Font-Size="X-Large"></asp:Label>
                <asp:CheckBoxList ID="cl_Inter" runat="server" AutoPostBack="True" RepeatDirection="Horizontal" RepeatLayout="Flow" Font-Size="X-Large" RepeatColumns="3">
            ...
            <asp:HyperLink ID="HyperLink1" runat="server" ImageUrl="~/youtube-brands.svg" NavigateUrl="https://www.youtube.com/" Height="30px" Width="30px">HyperLink</asp:HyperLink><br />
